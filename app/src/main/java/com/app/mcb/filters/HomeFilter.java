 ...
 */
public class HomeFilter implements View.OnClickListener {
    ...
    public static HomeFilter addFilterView(Context context, View view, CommonListener commonListener) {
        return new HomeFilter(context, view, commonListener);
    }

    public HomeFilter(Context context, View view, CommonListener commonListener) {
